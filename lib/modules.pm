...
############# Configuration dirs ###############
my $addons_dir = "/app/easy_nas/addons";
my $lang_dir= "/app/easy_nas/lang";
my $mount_dir = "/mnt";

##########  Configuration files ############
my $lang_conf="/etc/easynas/easynas.lang";
my $conf_cron="/etc/cron.d/easynas.cron";
my $conf_roles="/etc/easynas/easynas.roles";
my $conf_webui = "/etc/easynas/lighttpd/easynas.conf";
my $conf_cert  = "/easynas/certs/easynas.pem";
