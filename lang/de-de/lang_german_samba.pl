...
$TEXT{'samba_path'} = "Pfad";
$TEXT{'samba_on_off'} = "An / Aus";
$TEXT{'samba_settings'} = "Einstellungen";
$TEXT{'samba_delete'} = "Löschen";
$TEXT{'samba_shared_vol'} = "Shared Volumes";
$TEXT{'samba_delete_share'} = "Freigabe löschen ?";
$TEXT{'samba_add_smb'} = "Freigabe erstellen";
$TEXT{'samba_share_name'} = "Freigabe";
$TEXT{'samba_readonly'} = "lesen";
$TEXT{'samba_allow_guest'} = "Allow Guest";
$TEXT{'samba_browsable'} = "Browsable";
$TEXT{'samba_save'} = "Speichern";
$TEXT{'samba_reset'} = "Zurücksetzen";
$TEXT{'samba_not_installed'} = "Samba ist nicht installiert";
$TEXT{'samba_missing_name'} = "Name nicht eingetragen"; 
$TEXT{'samba_share_exists'} = "Freigabe breits vorhanden"; 
$TEXT{'samba_help'} = "
